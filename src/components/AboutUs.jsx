...
const AboutUs = () => {
  return (
    <section
      className="bg-white py-12  md:px-12 lg:px-36 w-full my-12"
      id="about"
    >
      <div className="mx-auto flex flex-col lg:flex-row items-center justify-between px-6 md:px-12 my-10">
