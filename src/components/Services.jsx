  ...
  const serviceData = [
    {
      ...
      description: 'Manufacturing Operations Management Digital twin Digital thread Process / Machine Integration Process Automation AI/ML based Non-Conformance Management Automated Visual Inspection Inspector / Operator Training Management Asset Management',
    },
    {
      img: Data,
...
- Manufacturing Instructions`,
  ...
  return (
    <div className="bg-[#F6F6F6CC] 2xl:px-[20%] lg:px-24">
