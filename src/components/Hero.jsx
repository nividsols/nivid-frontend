...
const Hero = () => {
  return (
    <div className='flex flex-col lg:flex-row justify-between items-center my-10 lg:my-20 px-24 2xl:px-[10%] lg:px-24'>
      <div className='w-full lg:w-1/2 text-center lg:text-left'>
        <h1 className='text-3xl lg:text-4xl 2xl:text-6xl leading-[3rem] lg:leading-[4rem] 2xl:leading-[5rem] font-medium text-white my-5 lg:my-7'>
        ...
        <button className='py-3 lg:py-5 2xl:py-6 px-6 lg:px-10 2xl:px-12 text-white bg-gradient-to-r from-[#399FD8] via-[#0775B4] to-[#003756] mt-8 lg:mt-14 2xl:mt-16'>
          Discover More
        </button>
      </div>
